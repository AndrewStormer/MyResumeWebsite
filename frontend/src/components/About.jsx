  ...
  return (
    <div className='aboutContainer'>
      ...
      <p>
          ...
          such as Node, React, and querying languages MongoDB/Mongoose, and SQL (MySQL & Microsoft SQL Server).
          I am currently preparing to work as a Software Engineer Intern at Lumeris, working as part of a team in an
      ...
      <a href="../Andrew_Stormer_Resume_SP2024.pdf" download>Download and view my resume</a>
    </div>
